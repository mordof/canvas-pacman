...
//import { default as map, filterWaypointsByDirection } from '../../map';
...
//          ghost.nextWayPoint = map.wayPointIndex[ghost.wayPoints[ghost.nextWayPoint][1]][ghost.wayPoints[ghost.nextWayPoint][0]];
//          ghost.AIstate = 'roaming';
//        }
//      } else { // default state of "roaming"
//        // we're currently on a waypoint. get the ID.
//        const wayPointID = map.wayPointIndex[ghost.yTilePos][ghost.xTilePos];
//        const pacmanWaypointID = map.wayPointIndex[pacman.yTilePos][pacman.xTilePos]

//        const waypoints = map.getWaypointsToDest(wayPointID, pacmanWaypointID)
//        let direction;
...
//          ghost.childWaypoints = map.wayPoints[wayPointID][2];

//          let newWayPoint = newWaypoints[(Math.random() * newWaypoints.length) | 0];
