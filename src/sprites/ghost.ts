...
export default class Ghost extends ControllableBase {
  ...
  wayPoints = [[14, 15, "upState"], [14, 12, "leftState"], [13, 12]]
  deathWaypointPath = null;
  nextWayPoint = 1;
  moveSpeed = 5;
  ...
  startPanic() {
    ...
    setTimeout(
      () => {
        this.endPanic();
        // TODO: influence scoreKeeper's ghost kill counter here instead.
        pacman.clearGhostCounter();
      },
      this.panicDuration,
    );
  }
